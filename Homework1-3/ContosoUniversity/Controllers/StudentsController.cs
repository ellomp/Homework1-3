...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        //is called without a previous failure. When it's called by the HttpPost Delete method 
        //in response to a database update error, the parameter is true and an error message 
        ...
        // POST: Students/Delete/5       //delete action method
